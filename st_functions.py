...
def st_button(icon, url, label, iconsize):
    if icon == 'youtube':
        button_code = f'''
        <p>
            <a href={url} class="btn btn-outline-info btn-lg btn-block text-white" type="button" aria-pressed="true">
        ...
        button_code = f'''
        <p>
            <a href={url} class="btn btn-outline-light text-white btn-lg btn-block" type="button" aria-pressed="true">
                {label}
            </a>
        </p>'''
