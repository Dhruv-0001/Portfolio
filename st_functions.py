...
def st_button(icon, url, label, iconsize):
    if icon == 'youtube':
        button_code = f'''
        <p>
            <a href={url} class="linkbtn btn btn-outline-warning btn-lg btn-block" type="button" aria-pressed="true">
        ...
        button_code = f'''
        <p>
            <a href={url} class="btn btn-outline-warning  btn-lg btn-block" class="linkbtn" type="button" aria-pressed="true">
